...
type Evt struct {
	...
	ToURL    bool        `json:"to_url"`    // when true, deliver outgoing event as a POST to ReplyURL
	ReplyURL string      `json:"reply_url"` // the POST URL for responses, e.g. webhooks, SNS, etc.
